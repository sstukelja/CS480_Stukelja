...
void Engine::Run()
{
  ...
  cout << "Click with either mouse button to toggle orbit direction" << endl;
  cout << "Press the left arrow key to orbit clock-wise" << endl;
  cout << "Press the right arrow key to orbit counter clock-wise" << endl;
